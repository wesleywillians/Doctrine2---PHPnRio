 ...
 */
class ApplicationEntityNoticiaProxy extends \Application\Entity\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'titulo', 'texto', 'categoria', 'fonte');
    }
