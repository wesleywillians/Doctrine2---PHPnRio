 ...
 */
class ApplicationEntityArtigoProxy extends \Application\Entity\Artigo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setAutor(\Application\Entity\Autor $autor)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'titulo', 'texto', 'categoria', 'autor');
    }
